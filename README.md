...
- **测试模型**: MobileNetV2 / ResNet50 / ShuffleNetV2 x0.5 / MobileViT-S / YOLOv8n
...
| **ShuffleNetV2 x0.5** | ORT | 183.76 | 2.89 | 2.92 | 339.8 | - |
| **ShuffleNetV2 x0.5** | MNN | 89.19 | **1.69** | 1.92 | 577.6 | **1.71x** |
| **ResNet50** | ORT | 388.38 | 84.48 | 86.94 | 11.77 | - |
| **ResNet50** | MNN | 497.68 | **82.54** | 85.27 | 11.95 | **1.02x** |
| **MobileViT-S** | ORT | 162.55 | 71.31 | 76.63 | 13.79 | - |
| **MobileViT-S** | MNN | 95.16 | **59.65** | **61.84** | **16.62** | **1.20x** |
...
| **MobileViT-S** | 1.000000 | 0.000173 | 0.0002% |
...
支持的模型: `mobilenetv2`, `resnet50`, `shufflenet_v2_x0_5`, `mobilevit_s`, `yolov8n`
